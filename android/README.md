# Scrabble Word Scorer Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:scrabblescorer-api:1.1.13'
}
```
...
```java
import com.apiverve.scrabblescorer.ScrabbleWordScorerAPIClient;
import com.apiverve.scrabblescorer.APIResponse;
import com.apiverve.scrabblescorer.APIException;

// Initialize the client
ScrabbleWordScorerAPIClient client = new ScrabbleWordScorerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("word", "QUIZ");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/scrabblescorer](https://docs.apiverve.com/ref/scrabblescorer)
...
- **Documentation:** [https://docs.apiverve.com/ref/scrabblescorer](https://docs.apiverve.com/ref/scrabblescorer)
- **Issues:** [GitHub Issues](https://github.com/apiverve/scrabblescorer-api/issues)
