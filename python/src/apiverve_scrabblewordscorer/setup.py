...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/scrabblescorer',
        'Source': 'https://github.com/apiverve/scrabblescorer-api',
        'Bug Tracker': 'https://github.com/apiverve/scrabblescorer-api/issues'
    },
    classifiers=[
