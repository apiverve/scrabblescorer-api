...
class TestScrabblescorerAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ScrabblescorerAPIClient(self.api_key)

    @patch('apiverve_scrabblewordscorer.apiClient.requests.get')
