...
const (
	baseURL        = "https://api.apiverve.com/v1/scrabblescorer"
	defaultTimeout = 30 * time.Second
)

// Client is the Scrabble Word Scorer API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Scrabble Word Scorer API client.
...
// Execute makes a request to the Scrabble Word Scorer API with typed parameters.
//
