...
class scrabblescorerWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/scrabblescorer');
        }
        ...
        this.validationRules = {"word":{"type":"string","required":true},"language":{"type":"string","required":false,"default":"english"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/scrabblescorer`);
        }
    }
...
module.exports = scrabblescorerWrapper;
