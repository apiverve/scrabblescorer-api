...
namespace APIVerve.API.ScrabbleWordScorer
{
    ...
    /// <summary>
    /// Client for the ScrabbleWordScorer API
    /// </summary>
    public class ScrabbleWordScorerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/scrabblescorer";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "language", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public ScrabbleWordScorerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ScrabbleWordScorerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ScrabbleWordScorerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ScrabbleWordScorerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ScrabbleWordScorerQueryOptions options)
        {
        ...
        public ResponseObj Execute(ScrabbleWordScorerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ScrabbleWordScorerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ScrabbleWordScorerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ScrabbleWordScorerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ScrabbleWordScorerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ScrabbleWordScorerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ScrabbleWordScorerQueryOptions options)
        {
